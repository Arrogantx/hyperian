...
// netlify/functions/rpc-proxy.ts
var rpc_proxy_exports = {};
__export(rpc_proxy_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(rpc_proxy_exports);
var import_node_fetch = __toESM(require_lib2(), 1);
var RPC_URL = "https://rpc.hyperliquid.xyz/evm";
var handler = async (event) => {
  try {
    const body = JSON.parse(event.body || "{}");
    const response = await (0, import_node_fetch.default)(RPC_URL, {
      method: "POST",
