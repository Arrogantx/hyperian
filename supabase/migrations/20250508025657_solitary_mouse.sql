/*
  ...
  1. Changes
    - Recreate whitelist table with proper constraints
    - Update RLS policies to handle case-insensitive wallet addresses
    - Fix policy permissions for admin access
    - Add indexes for better query performance

  2. Security
    - Enable RLS
    - Public read-only access for whitelist status checks
    - Admin-only access for all operations using wallet addresses
*/
